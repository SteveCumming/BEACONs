...
parameters <- list(.globals=list(burnStats="nPixelsBurned"),
                   ...
                   fireRegimeModel=list(fireCause=c("L"), fireEpoch=c(1985,2014))
              )

modules <- list("scfmCrop", "scfmLandcoverInit", "forestAge", "forestSuccessionBeacons","LccToBeaconsReclassify","fireRegimeModel")
...
objects <- list(vegInput="vegInput", ageMapInit="ageMapInit",firePointsInput="firePointsInput",studyArea="studyArea",cacheLoc="cacheLoc")
